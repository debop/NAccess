...
{
    public class FluentDomainTestFixtureBase : FluentDatabaseTestFixtureBase
    {
        #region << logger >>
        ...
        protected virtual void OnTestFixtureSetUp()
        {
            InitializeNHibernateAndIoC(ContainerFilePath,
                                       ...
                                       new PascalNamingConvention(new[] { "Code", "Name" }));
        ...
        {
            return MappingInfo.From(typeof(CompanyMap).Assembly);
        }
